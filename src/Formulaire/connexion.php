            ...
            <form action ="#" method ="post"><!-- Ajout de l'attribut method -->
                ...
                <div class="form-group">
                    ...
                    <div class="password-container"><!-- Ajout d'une div pour le conteneur du mot de passe -->
                        <input type="password" id="motdepasse" name="motdepasse" required><!-- Ajout de l'attribut id -->
                    </div>
                </div>
                <button type="submit" class="submit-btn">Se connecter</button><!-- Ajout d'une classe pour le bouton -->
                <p class="signup-link">Pas encore de compte ? <a href="inscription.html">S'inscrire</a></p><!-- Ajout d'une classe pour le paragraphe -->
            </form>
        </div>
    </body>    
</html>